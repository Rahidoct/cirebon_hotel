                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <form action="booking_act.php" method="post">
                            ...
                            <center><button class="site-btn" style="border-radius: 20px;">CEK KETERSEDIAAN KAMAR</button></center>
                        </form>
                        ...
                        <center>
                            ...
                            if(isset($_SESSION['booking_kamar_status'])){
                                if($_SESSION['booking_kamar_status'] == "tersedia"){
                                    ?>
                                    <a href="checkout.php" style="border-radius: 20px;" class="site-btn bg-success">CHECK OUT &nbsp; <i class="fa fa-arrow-right"></i></a>
                                    <?php
                                }
