        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <a href="index.php" style="color: white;"><strong>CIREBON HOTEL</strong></a>
                    </div>
                    <p>Cuma dicirebon hotel, penginapan berasa dirumah dengan kamar terbaik, harga termurah. mewah kamar nya, indah nuasanya.</p>
            ...
            <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
                <div class="footer__widget">
                    ...
                    <div class="footer__newslatter text-white">
                        <p>Follow sosial media <b>Cirebon Hotel</b></p>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright © <?php echo date('Y'); ?> All rights reserved | <a href="https://colorlib.com" target="_blank">Cirebon Hotel</a></p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
        </div>
