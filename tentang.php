        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="about__pic">
                    <img src="assets/img/popular2.jpg" alt="" style="height: 500px; border-radius: 50px;">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="testimonial__text">
                    ...
                    <p>
                        “Booking kamar jadi lebih mudah di website cirebon hotel. tinggal buka websitenya, lihat kamar,
                        dan checkout deh. kamarnya juga bagus dan mewah dengan nuansa alamnya yang asri.
            ...
            <div class="col-lg-6 p-0">
                <div class="testimonial__pic set-bg" data-setbg="gambar/kamar/1580918857_pexels-suhel-vba-3659683.jpg"></div>
            </div>
        </div>
    </div>
</section>
