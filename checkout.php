        ...
        <div class="checkout__form">
            <form action="checkout_act.php" method="post">
               ...
               <div class="col-lg-4 col-md-6">
                <div class="checkout__order" style="border-radius: 20px;">
                    <h4 class="order__title">Pesanan Kamu</h4>
                    ...
                    <button type="submit" class="site-btn" style="border-radius: 20px;">BAYAR</button>
                </div>
            </div>
        </div>
    </form>
