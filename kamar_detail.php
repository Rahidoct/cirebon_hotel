 					...
 					<div class="col-lg-3 col-md-3">
 						<ul class="nav nav-tabs" role="tablist">
 							...
 							<?php if($d['kamar_foto1'] == ""){ ?>
 								<li class="nav-item">
 									<a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
 										<div style="border-radius: 20px;" class="product__thumb__pic set-bg" data-setbg="gambar/sistem/kamar.png"></div>
 									</a>
 								</li>
 							<?php }else{ ?>
 								<li class="nav-item">
 									<a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
 										<div style="border-radius: 20px;" class="product__thumb__pic set-bg" data-setbg="gambar/kamar/<?php echo $d['kamar_foto1'] ?>"></div>
 									</a>
 								</li>
 							<?php } ?>
 							...
 							<?php }else{ ?>
 								<li class="nav-item">
 									<a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
 										<div style="border-radius: 20px;" class="product__thumb__pic set-bg" data-setbg="gambar/kamar/<?php echo $d['kamar_foto2'] ?>"></div>
 									</a>
 								</li>
 							<?php } ?>
 							...
 							<?php }else{ ?>
 								<li class="nav-item">
 									<a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
 										<div style="border-radius: 20px;" class="product__thumb__pic set-bg" data-setbg="gambar/kamar/<?php echo $d['kamar_foto3'] ?>"></div>
 									</a>
 								</li>
 							<?php } ?>
 					...
 					<div class="col-lg-6 col-md-9">
 						<div class="tab-content">
 							...
 							<?php if($d['kamar_foto1'] == ""){ ?>
 								<div class="tab-pane active" id="tabs-1" role="tabpanel">
 									<div class="product__details__pic__item">
 										<img style="border-radius: 20px;" src="gambar/sistem/kamar.png" alt="">
 									</div>
 								</div>
 							<?php }else{ ?>
 								<div class="tab-pane active" id="tabs-1" role="tabpanel">
 									<div class="product__details__pic__item">
 										<img style="border-radius: 20px;" src="gambar/kamar/<?php echo $d['kamar_foto1'] ?>" alt="">
 									</div>
 								</div>
 							<?php } ?>
 							...
 							<?php }else{ ?>
 								<div class="tab-pane" id="tabs-2" role="tabpanel">
 									<div class="product__details__pic__item">
 										<img style="border-radius: 20px;" src="gambar/kamar/<?php echo $d['kamar_foto2'] ?>" alt="">
 									</div>
 								</div>
 							<?php } ?>
 							...
 							<?php }else{ ?>
 								<div class="tab-pane" id="tabs-3" role="tabpanel">
 									<div class="product__details__pic__item">
 										<img style="border-radius: 20px;" src="gambar/kamar/<?php echo $d['kamar_foto3'] ?>" alt="">
 									</div>
 								</div>
 							<?php } ?>
 						...
 						<div class="product__details__text">
 							...
 							<div class="shop__sidebar__tags mb-5">
 								...
 								while($f = mysqli_fetch_array($fasilitas)){
 									?>
 									<a href="#" style="border-radius: 20px;"><i class="fa <?php echo $f['fk_icon'] ?>"></i> &nbsp; <?php echo $f['fk_nama'] ?></a>
 									<?php
 								}	
 								?>
 							</div>
 							...
 							<div class="product__details__cart__option"> 								
 								<a style="border-radius: 20px;" href="booking.php?id=<?php echo $d['kamar_id'] ?>" class="primary-btn">Booking Kamar</a>
 							</div>
 					...
 					<div class="col-lg-12">
 						<div class="product__details__tab">
 							<ul class="nav nav-tabs" role="tablist">
 								...
 								<li class="nav-item">
 									<a class="nav-link" data-toggle="tab" href="#tabs-6" role="tab">Review Dari Customer (<?php echo $p ?>)</a>
 								</li>
 							</ul>
 							<div class="tab-content">
 								<div class="tab-pane active" id="tabs-5" role="tabpanel">
 									<div class="product__details__tab__content">
 										...
 										<div class="product__details__tab__content__item">
 											...
 											<?php }else{ ?>
 												<br><br>
 												<center><h4>Belum ada keterangan.</h4></center>
 												<br>
 											<?php } ?>
 										</div>
 								...
 								<div class="tab-pane" id="tabs-6" role="tabpanel">
 									<div class="product__details__tab__content">
 										<div class="product__details__tab__content__item">
 											<h5>Rating & Review Dari Customer</h5>
 											<?php 
 											if($p > 0){
 												?>
 												...
 												<div class="row">
 													...
 													<?php 
 													$id_kamar = $d['kamar_id'];
 													$review = mysqli_query($koneksi,"select * from rating,customer,invoice where rating_invoice=invoice_id and invoice_customer=customer_id and rating_invoice='$id_kamar'");
 												...
 												?>
 												<br><br>
 												<center><h4>Belum ada review.</h4></center>
 												<br>
 												<?php 
 											}
 											?>
 							...
 							<ul class="product__hover">
 								<li>
 									<a href="kamar_detail.php?id=<?php echo $d['kamar_id']; ?>">
 										<img style="border-radius: 20px;" src="gambar/sistem/kamar.png">
 									</a>
 								</li>
 							</ul>
 						<?php }else{ ?>
 							...
 							<ul class="product__hover">
 								<li>
 									<a href="kamar_detail.php?id=<?php echo $d['kamar_id']; ?>">
 										<img style="border-radius: 20px;" src="gambar/kamar/<?php echo $d['kamar_foto1'] ?>">
 									</a>
 								</li>
 							</ul>
